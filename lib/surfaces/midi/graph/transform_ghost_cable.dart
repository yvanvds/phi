...
/// In-flight cable drawn while the performer drags from a node's output port
/// toward a (yet-unknown) target. The head follows the pointer; the tail
/// anchors at the source port. Dashed throughout to signal "not committed".
class TransformGhostCable extends StatelessWidget {
  const TransformGhostCable({
