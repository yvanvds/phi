...
/// (issue #95).
///
/// The five transforms whose behaviour lives in a table or rule-list get a
/// bespoke dialog rather than the generic scalar editor, because a map,
/// rule-list, axis set, or scale preset doesn't fit the `withParam(String,
/// num)` seam. The chip context menu asks [hasTypedEditor] whether to route
/// here at all, then calls [buildTypedParamEditor] to build the dialog.
///
